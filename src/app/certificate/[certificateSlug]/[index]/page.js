      ...
      <footer className="bg-[#101010] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav className="flex space-x-6 justify-center" aria-label="Social Media Links">
            ...
            <Link href="https://linkedin.com/in/pankajsingh1work" target="_blank" rel="noopener noreferrer" className="text-[#E0E0E0] hover:text-[#F0F0F0] transition" aria-label="Pankaj Singh on LinkedIn">
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: `${certificate.hero?.title}, Pankaj Singh, certificate, ${skillsKeywords}, ${certificate.hero?.issuedBy}, achievement`,
    robots: "index, follow",
    openGraph: {
      title: `${certificate.hero?.title || "Certificate"} - Pankaj Singh`,
      description: certificate.hero?.description || "Detailed view of a certificate earned by Pankaj Singh.",
